package net.gumyo.bmdm.security;
...
import net.gumyo.bmdm.security.handler.LoginFailure;
import net.gumyo.bmdm.security.handler.LoginSuccess;
...
public class SecurityConfig {
    ...
    void setDefaultConfig(HttpSecurity http) throws Exception {
    ...
    void setFilterConfig(HttpSecurity http) throws Exception {
